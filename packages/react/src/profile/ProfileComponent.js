    ...
    <Fade in={loaded}>
      ...
      >
        ...
        >
          ...
          <Typography>
            Additionally, data entered is also saved to <code>
            localStorage</code> and will be reloaded asynchronously via
            the <code>redux-thunk</code> library in the redux operation.
          </Typography>
        </Grid>
        <Grid
          item
